...
<head>
    <meta charset="UTF-8">
    <title>Acceptance Dashboard</title>
...
<nav class="navbar navbar-expand-xl navbar-dark bg-dark container">
    ...
    <div class="container">
    <h2 class="align-items-center text-center bg-light">All Repair Products</h2>
        ...
        <tbody>
            ...
            <c:forEach items="${repairs}" var="repair">
                <tr>
                    ...
                    <td><a href="/acceptance/newReport/${repair.id}">Create a Report</a> </td>
                </tr>
    ...
    <h2 class="text-center align-items-center bg-light">All Reports</h2>
    <table class="table table-bordered table-hover">
        <thead class="table-dark">
        <tr>
